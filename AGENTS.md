...
- `src/agent/metrics_collector.py` — Counter/Gauge/Histogram/Span 采集器
- `src/agent/metrics_store.py` — SQLite 持久化
- `src/agent/metrics_callback.py` — LangGraph 回调集成
- `src/agent/cost_calculator.py` — 统一 MODEL_COSTS
- `src/agent/system_metrics.py` — psutil 系统指标
...
- `docs/metrics-observability-plan.md` — Metrics & Observability 方案
